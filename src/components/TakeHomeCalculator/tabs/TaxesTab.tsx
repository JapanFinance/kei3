        ...
        <ResultRow
          ...
          labelSuffix={
            results.residenceTax.nonTaxableStatus ? (
              <SimpleTooltip>
                {`No residence tax is levied: ${NON_TAXABLE_STATUS_LABELS[results.residenceTax.nonTaxableStatus]} with 合計所得金額 of ${formatJPY(NON_TAXABLE_STATUS_INCOME_LIMIT)} or less are exempt.`}
              </SimpleTooltip>
            ) : undefined
          }

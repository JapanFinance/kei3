 ...
 * ({@link calculateDependentIncomeAdjustmentDeduction}), then
 * {@link composeNetIncomeComponents} for the pension side.
 */
export function calculateDependentNetIncomeComponents(
  ...
  return composeNetIncomeComponents({
    netEmploymentIncomeBeforePensionAdjustment: calculateDependentNetEmploymentIncome(
      dependent,
      year,
    ),
 ...
 * @see https://www.nta.go.jp/taxes/shiraberu/taxanswer/shotoku/1411.htm
 */
export function hasIncomeAdjustmentDeductionDependent(
...
export function getDisabilityDeduction(
  ...
  const getAmount = (
    deductions: typeof NATIONAL_TAX_DEDUCTIONS | typeof RESIDENCE_TAX_DEDUCTIONS,
  ) => {
    switch (disability) {
      case 'regular':
...
const SPOUSE_SPECIAL_DEDUCTION_TABLE = {
  NATIONAL: [
    {
      maxIncome: 950_000,
      amounts: { under900: 380_000, bracket900_950: 260_000, bracket950_1000: 130_000 },
    },
    {
      maxIncome: 1_000_000,
      amounts: { under900: 360_000, bracket900_950: 240_000, bracket950_1000: 120_000 },
    },
    {
      maxIncome: 1_050_000,
      amounts: { under900: 310_000, bracket900_950: 210_000, bracket950_1000: 110_000 },
    },
    {
      maxIncome: 1_100_000,
      amounts: { under900: 260_000, bracket900_950: 180_000, bracket950_1000: 90_000 },
    },
    {
      maxIncome: 1_150_000,
      amounts: { under900: 210_000, bracket900_950: 140_000, bracket950_1000: 70_000 },
    },
    {
      maxIncome: 1_200_000,
      amounts: { under900: 160_000, bracket900_950: 110_000, bracket950_1000: 60_000 },
    },
    {
      maxIncome: 1_250_000,
      amounts: { under900: 110_000, bracket900_950: 80_000, bracket950_1000: 40_000 },
    },
    {
      maxIncome: 1_300_000,
      amounts: { under900: 60_000, bracket900_950: 40_000, bracket950_1000: 20_000 },
    },
    {
      maxIncome: 1_330_000,
      amounts: { under900: 30_000, bracket900_950: 20_000, bracket950_1000: 10_000 },
    },
  ],
  RESIDENCE: [
    {
      maxIncome: 1_000_000,
      amounts: { under900: 330_000, bracket900_950: 220_000, bracket950_1000: 110_000 },
    },
    {
      maxIncome: 1_050_000,
      amounts: { under900: 310_000, bracket900_950: 210_000, bracket950_1000: 110_000 },
...
function getSpouseSpecialDeduction(
  ...
  if (spouseNetIncome <= eligibilityMax || spouseNetIncome > SPOUSE_SPECIAL_DEDUCTION_MAX_INCOME) {
    return { national: 0, residence: 0 };
  }

  const getAmount = (
    table:
      | typeof SPOUSE_SPECIAL_DEDUCTION_TABLE.NATIONAL
      | typeof SPOUSE_SPECIAL_DEDUCTION_TABLE.RESIDENCE,
  ) => {

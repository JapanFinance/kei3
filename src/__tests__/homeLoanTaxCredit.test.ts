...
describe('applyHomeLoanTaxCredit', () => {
  ...
  it('treats an explicit isTokuteiShutoku: true the same as the default for a 2014-2021 move-in', () => {
    ...
    const explicit = applyHomeLoanTaxCredit(
      { ...base, isTokuteiShutoku: true },
      4_000_000,
      202_500,
      3_000_000,
    );
  ...
  it('ignores isTokuteiShutoku for the 2022+ band (no non-特定取得 variant — 5% / ¥97,500 either way)', () => {
    const tokutei = applyHomeLoanTaxCredit(
      { moveInYear: 2024, creditAmount: 350_000, isTokuteiShutoku: true },
      4_000_000,
      202_500,
      3_000_000,
    );

    ...
    periods: [
      {
        ...
        params: {
          ...
          supportPerCapita: 17600,
          ltcPerCapitaForEligible: 17800,
          medicalCap: 670000,
          supportCap: 260000,
      ...
      },
      {
        ...
        params: {
          source:
            'https://www.hokeniryo.metro.tokyo.lg.jp/kenkou/kokuho/aramashi/hokennryou/h30hokenryougaku',
          medicalRate: 0.0771,
          supportRate: 0.0269,
    ...
    periods: [
      {
        ...
        params: {
          source:
            'https://www.city.taito.lg.jp/kurashi/zeikin/kokuminkenkohoken/hokenryou/20130605104825870.html',
          medicalRate: 0.0751,
          supportRate: 0.028,
          ltcRateForEligible: 0.0243,
          medicalPerCapita: 47600,
    ...
    periods: [
      {
        ...
        params: {
          source:
            'https://www.city.sumida.lg.jp/kurashi/kenkouhoken/kokuminkenkouhoken/kokuhoryoukeisan.html',
          medicalRate: 0.0751,
          supportRate: 0.028,
          ltcRateForEligible: 0.0243,
          medicalPerCapita: 47600,
    ...
    periods: [
      {
        ...
        params: {
          source:
            'https://www.city.toshima.lg.jp/109/tetsuzuki/nenkin/kenkohoken/hokenryo/004922.html',
          medicalRate: 0.0751,
          supportRate: 0.028,
          ltcRateForEligible: 0.0243,
          medicalPerCapita: 47600,
 ...
 */
export const NATIONAL_HEALTH_INSURANCE_REGION_OPTIONS = Object.entries(allNHIRegions).map(
  ([regionKey, def]) => ({
    id: regionKey,

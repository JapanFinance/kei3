...
- The quintile bands appear only while 全世帯 is selected. The survey publishes 五分位値 for 全世帯 alone, reporting how each household type spreads across those same bands rather than giving each type its own, so the bands would disagree with the percentile estimate for any other type.

...
- Investment income can now be entered in Advanced mode: [capital gains on shares](https://www.nta.go.jp/taxes/shiraberu/taxanswer/shotoku/1463.htm), [dividends](https://www.nta.go.jp/taxes/shiraberu/taxanswer/shotoku/1330.htm) and [interest](https://www.nta.go.jp/taxes/shiraberu/taxanswer/shotoku/1310.htm), with a withholding designated account ([特定口座（源泉徴収あり）](https://www.nta.go.jp/taxes/shiraberu/taxanswer/shotoku/1476.htm)) entered as one entry from its annual transaction report. Each amount can be left to the tax withheld at source or reported on the tax return, under separate taxation (申告分離課税) or, for dividends, aggregate taxation (総合課税), and every result follows the choice, from take-home pay and the taxes to National Health Insurance premiums, the basic deduction, dependent eligibility and the furusato nozei limit. A reporting planner in the income details dialog finds the choices that keep the most and applies them. The dividend tax credit (配当控除), carrying a loss forward, and the foreign tax credit are not modelled yet.

### Updated

- The dependent-coverage (被扶養者) income test now counts investment receipts toward the annual income whatever their tax treatment, following the written practice of health insurance societies.

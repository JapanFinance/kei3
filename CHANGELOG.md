...
- Dividends on listed shares can now be reported under 総合課税 instead of 申告分離課税. The election is made once, in the income details dialog, for every reported dividend, because the tax law allows no mix of the two on one return ([措法8条の4②](https://laws.e-gov.go.jp/law/332AC0000000026#Mp-Ch_2-Se_1-At_8_4)); dividends left to the tax withheld at source are unaffected by it. Under 総合課税 the reported dividends join 総所得金額 as [配当所得](https://www.nta.go.jp/taxes/shiraberu/taxanswer/shotoku/1330.htm) and are taxed in the progressive brackets and at the 10% residence-tax rate together with the other income, entering 合計所得金額 and everything keyed to it the same way as income reported under 申告分離課税. The [配当控除](https://www.nta.go.jp/taxes/shiraberu/taxanswer/shotoku/1250.htm) is not applied yet, so for dividends from a domestic company the tax under this election is overstated until it follows; no capital loss is set against dividends reported this way. The income details dialog also gains a comparison of the three elections — 申告不要, 申告分離課税 and 総合課税 — showing the amount kept after tax and social insurance, each tax, the social insurance and the furusato nozei limit under each.

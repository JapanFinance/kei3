...
- The 65+ long-term care premium (介護保険料, 第1号被保険者) is now estimated by default. The estimate multiplies the selected prefecture's average base amount (基準額) from the [MHLW FY2024-2026 publication](https://www.mhlw.go.jp/stf/newpage_40211.html) by the standard 13-tier income multiplier ([介護保険料等における基準額の調整について, PDF](https://www.mhlw.go.jp/content/12300000/001576452.pdf)), judged from the entered income and household. Actual premiums are set per municipality and can differ substantially; the estimate can be switched off to enter the billed amount from the 介護保険料決定通知書 as before.
